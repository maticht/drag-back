...
class WeeklyReferralRewardsController {
    async claim(req, res, next) {
        try {
            ...
            const user = await User.findOne({chatId: req.body.userId}, 'weeklyReferralRewards score overallScore username');
            console.log(user)
            ...
            addToBuffer(req.body.userId, user.username,`collect weekly reward ref`, userAgentString, user.score);
