...
class WeeklyReferralRewardsController {
    async claim(req, res, next) {
        try {
            ...
            const user = await User.findOne({chatId: req.body.userId}, 'weeklyReferralRewards score overallScore');
            console.log(user)
            ...
            addToBuffer(req.body.userId, `collect weekly reward ref`, userAgentString, null);
